...
Once the `conda-forge` channel has been enabled, `rsconnect-jupyter` can be installed with:

```
conda install rsconnect-jupyter
```

It is possible to list all of the versions of `rsconnect-jupyter` available on your platform with:
